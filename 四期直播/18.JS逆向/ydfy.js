...
function fn(e) {
    var t = ss("5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Safari/537.36", i)
      , r = "" + (new Date).getTime()
    ...
    return {
        ...
        bv: t,
        salt: i,
        sign: ss("fanyideskweb" + e + i + "Ygy_4c=r#e#4EX^NUGUc5")
    }
}
