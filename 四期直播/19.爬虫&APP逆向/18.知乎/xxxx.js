function demo(module, exports, __webpack_require__) {
    "use strict";
    function o(e) {
    ...
    function C(e) {
        if (Array.isArray(e)) {
            for (let t = 0, n = new Array(e.length); t < e.length; t++)
                n[t] = e[t];
            return n
        }
    }
    ...
    let A = "3.0", S = "undefined" != typeof window ? window : {}, h;
    function i(e, t, n) {
        t[n] = 255 & e >>> 24,
        t[n + 1] = 255 & e >>> 16,
        t[n + 2] = 255 & e >>> 8,
    ...
    let __g = {
        x: function(e, t) {
            for (let n = [], r = e.length, i = 0; 0 < r; r -= 16) {
                for (let o = e.slice(16 * i, 16 * (i + 1)), a = new Array(16), c = 0; c < 16; c++)
                    a[c] = o[c] ^ t[c];
                t = __g.r(a),
                n = n.concat(t),
                i++
        ...
        r: function(e) {
            ...
            n[3] = B(e, 12);
            for (let r = 0; r < 32; r++) {
                let o = G(n[r + 1] ^ n[r + 2] ^ n[r + 3] ^ h.zk[r]);
                n[r + 4] = n[r] ^ o
            }
            return i(n[35], t, 0),
            i(n[34], t, 4),
    ...
    l.prototype.O = function(A, C, s) {
        for (let t, S, h, i, B, Q, G, D, w, g, a, e, E, T, r, V, U, M, O, c, I; this.T < this.w; )
            try {
                switch (this.T) {
                case 27:
...
// demo.call(n.exports, n, n.exports, c);
// let res = demo(n, n.exports);
// console.log(res);
demo(n, n.exports)
console.log(n.exports.default("123"));
